...
export default function LandingView({
  ...
  const MODS = [
    ...
    { key: "comercial",     icon: "🎙️", label: "Comercial IA",                              color: "#10b981", badge: "🎙️",       desc: isEs ? "Comerciales profesionales con voz IA" : "Professional AI commercials with voice", vid: "/gallery/comercial-chef.mp4" },
