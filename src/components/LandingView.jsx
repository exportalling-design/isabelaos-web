  ...
  return (
    <div style={{ fontFamily: V.ffB, background: V.bg, color: V.text, overflowX: "hidden", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ fontFamily: V.ffU, fontSize: 12, fontWeight: 700, letterSpacing: 2,
          ...
          {isEs ? "⚡ SEEDANCE 2.0 YA DISPONIBLE — Haz click para probarlo gratis" : "⚡ SEEDANCE 2.0 NOW AVAILABLE — Click to try it free"}
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {user
            ...
            : <button onClick={onOpenAuth} style={{ background: `linear-gradient(135deg,${V.fire},${V.gold})`, border: "none", borderRadius: 10, color: "#000", fontFamily: V.ffU, fontSize: 13, fontWeight: 700, padding: "9px 20px", cursor: "pointer", boxShadow: "0 0 24px rgba(255,90,0,.3)" }}>{isEs ? "Entrar gratis →" : "Enter free →"}</button>
          }
        </div>
      </nav>
      ...
      <section id="hero" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", padding: "132px 32px 60px", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr 480px", gap: 0, maxWidth: "100%", margin: "0 auto", width: "100%", alignItems: "stretch", minHeight: "calc(100vh - 96px)" }}>
          ...
          <div style={{ position: "relative", overflow: "hidden" }}>
            ...
            <h1 style={{ fontFamily: V.ffD, fontSize: "clamp(52px,8vw,104px)", lineHeight: 0.92, letterSpacing: 2, color: "#fff" }}>
          ...
          <div style={{ background: "rgba(6,7,12,.97)", display: "flex", alignItems: "center", justifyContent: "center", padding: "60px 32px", position: "relative" }}>
            ...
            {user ? (
              ...
              <div style={{ background: "rgba(12,14,22,.98)", border: "1px solid rgba(255,90,0,.2)", borderRadius: 20, padding: 24, backdropFilter: "blur(40px)", boxShadow: "0 8px 32px rgba(0,0,0,.6), 0 0 0 1px rgba(255,255,255,.04), 0 0 80px rgba(255,90,0,.08)", animation: "floatUp .8s .2s cubic-bezier(.22,1,.36,1) both" }}>
                ...
                <div style={{ fontSize: 10, letterSpacing: 2, textTransform: "uppercase", color: V.muted, marginBottom: 8 }}>{isEs ? "Crear ahora →" : "Create now →"}</div>
      ...
      {/* TRUST BAR */}
      <div style={{ borderTop: `1px solid ${V.border2}`, borderBottom: `1px solid ${V.border2}`, background: V.bg2, display: "grid", gridTemplateColumns: "repeat(4,1fr)" }}>
        {[
          ...
          {MODS.map(m => (
            <div key={m.key} onClick={() => user ? go(m.key) : onStartDemo()} style={{ border: `1px solid ${V.border2}`, borderRadius: 18, background: V.bg2, overflow: "hidden", cursor: "pointer", transition: "all .3s" }}
              ...
              <div style={{ padding: "16px 18px 20px" }}>
                ...
                <div style={{ marginTop: 12, fontSize: 12, fontWeight: 700, color: m.color, letterSpacing: 0.5 }}>{isEs ? "Probar gratis →" : "Try free →"}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ padding: "0 32px 80px", maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2, background: V.border2, borderRadius: 18, overflow: "hidden" }}>
          {[
      ...
      {/* FINAL CTA */}
      <div style={{ margin: "0 32px 80px", borderRadius: 26, padding: "80px 60px", textAlign: "center", position: "relative", overflow: "hidden", background: "linear-gradient(135deg,rgba(255,90,0,.07),rgba(255,179,0,.04))", border: "1px solid rgba(255,90,0,.15)" }}>
        ...
        <p style={{ fontSize: 16, color: V.muted, maxWidth: 460, margin: "0 auto 28px", lineHeight: 1.7 }}>{isEs ? "Sin tarjeta. 10 Jades gratis. Cancela cuando quieras." : "No card. 10 free Jades. Cancel anytime."}</p>
      ...
      <footer style={{ borderTop: `1px solid ${V.border2}`, background: V.bg2, padding: "52px 32px 28px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1fr", gap: 44, marginBottom: 36 }}>
          <div>
