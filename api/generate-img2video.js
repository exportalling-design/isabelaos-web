// api/generate-img2video.js ✅ COLA REAL + AUTO-RELEASE
...
export default async function handler(req, res) {
  try {
    console.log("[GEN_I2V] VERSION 2026-02-03");
    ...
    console.log("[GEN_I2V] reserve_video_slot:", { canDispatch, lockErr: lockErr?.message || null });
