// api/generate-img2video.js ✅ COLA REAL + defaults consistentes
...
export default async function handler(req, res) {
  try {
    ...
    const jobRow = {
      ...
      mode: "i2v",
      prompt: finalPrompt,
      negative_prompt: tellsTruthy(finalNegative) ? finalNegative : "",
      width,
      height,
      fps,
      num_frames,
    ...
    if (lockErr || !canDispatch) return res.status(200).json({ ok: true, job_id: jobId, queued: true });
