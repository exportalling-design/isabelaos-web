// GET /api/live-overlay/[session_id]
...
// Lives outside /api/tiktok-live so the SPA catch-all rewrite in vercel.json
// never intercepts it and returns index.html instead of this HTML.
